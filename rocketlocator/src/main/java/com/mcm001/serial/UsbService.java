...
public class UsbService extends Service {
    ...
    */
    ...
    private void findSerialPortDevice() {
        ...
        if (!usbDevices.isEmpty()) {
            ...
            if (device == null) {
                // There are no USB devices connected (but usb host were listed). Send an intent to
                // MainActivity.
    ...
    */
    private void requestUserPermission() {
        Log.d(
                TAG,
                String.format("requestUserPermission(%X:%X)", device.getVendorId(), device.getProductId()));
        ...
        public void run() {
            ...
            if (serialPort != null) {
                if (serialPort.open()) {
                    ...
                    /**
                    * Current flow control Options: UsbSerialInterface.FLOW_CONTROL_OFF
                    ...
                    */
                    ...
                    //
                    // Some Arduinos would need some sleep because firmware wait some time to know whether a
                    // new sketch is going
